...
- [x] `configurable framework (generate different variants etc.)`

## Milestone 3
- [x] `basic peripherals (uart, timer, gpio etc.)`
...
## Milestone 4
- [x] `branch prediction (static, dynamic etc.)`
- [x] `hazard mitigation (forwarding, stalling etc.)`
- [x] `memory hierarchy (cache, tlb etc.)`
- [ ] `prefetching`
- [x] `pipelining (further)`
